...
from uwcs.website.events.models import *
...
class Command(NoArgsCommand):
    option_list = NoArgsCommand.option_list + (
        make_option('--locations',
            ...
            dest='locations',
            default=False,
            help='Populate database with some simple locations'
        ),
        make_option('--terms',
            action='store_true',
            dest='terms',
            default=False,
            help='Populate database with some warwick term dates',
        ),
        make_option('--event-types',
            action='store_true',
            dest='event-types',
            default=False,
            help='Populate database with some typical event types',
        ),
        make_option('--event',
            action='store_true',
            dest='event',
            default=False,
            help='Populate database with some typical events',
        ),
    )
