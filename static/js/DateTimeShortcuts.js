...
var DateTimeShortcuts = {
    ...
    addClock: function(inp) {
        ...
        quickElement('img', clock_link, '', 'src', '/static/img/icon_clock.gif', 'alt', gettext('Clock'));
    ...
    addCalendar: function(inp) {
        ...
        quickElement('img', cal_link, '', 'src', '/static/img/icon_calendar.gif', 'alt', gettext('Calendar'));
        shortcuts_span.appendChild(document.createTextNode('\240'));
