...
from uwcs_website.memberinfo.models import MemberJoin, warwick_week_for
from uwcs_website.memberinfo.models import Society, Term
...
def get_data():
    ...
    try:
        ...
        content = urlopen(PREFIX+settings.UNION_API_KEY+'/').read()
    finally:
