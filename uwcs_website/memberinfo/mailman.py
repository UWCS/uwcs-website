...
if 'USE_MAILMAN' in dir(settings) and settings.USE_MAILMAN:
    ...
    def validate_lists(*args, **kwargs):
        pass
    def import_lists(*args, **kwargs):
        pass
    def subscribe_member(*args, **kwargs):
        pass
    def unsubscribe_member(*args, **kwargs):
        pass
