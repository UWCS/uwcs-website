...
from uwcs_website.events import write_file_callback
from uwcs_website.shortcuts import flatten
...
class Event(models.Model):
    ...
    def time_string(self):
        ...
        if s.date() == f.date():
            return s.strftime(settings.DATE_FORMAT_STRING)+" - "+f.strftime(settings.SAME_SECOND_FORMAT)
        else:
            return s.strftime(settings.DATE_FORMAT_STRING)+" - "+f.strftime(settings.DATE_FORMAT_STRING)
...
class Signup(models.Model):
    ...
    def time_form(self):
        return self.time.strftime(settings.DATE_FORMAT_STRING)
