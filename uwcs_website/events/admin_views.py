...
from uwcs_website.shortcuts import path_processor
from uwcs_website.events.models import Event, Location
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            for signup in event.signup_set.all():
                signup.user.email_user(subject, message, settings.COMPSOC_EXEC_EMAIL)
